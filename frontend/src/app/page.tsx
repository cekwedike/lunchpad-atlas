...
export default function Home() {
  ...
  const features = [
    ...
    { title: "Interactive Quizzes", icon: Brain, color: "from-amber-500 to-orange-500", items: ["Live quizzes with real-time participation", "Self-paced quizzes with time limits", "Session, General, and Cohort mega types", "Answer streaks with bonus point multipliers", "Live leaderboard during quiz sessions"] },
