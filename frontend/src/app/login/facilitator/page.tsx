...
import { LogIn, ArrowLeft, Eye, EyeOff, Loader2, Users } from "lucide-react";
...
export default function FacilitatorLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0b0b45] via-purple-900 to-[#0b0b45] flex flex-col items-center justify-center p-8" suppressHydrationWarning>
      {/* Back Button */}
      <button
        onClick={() => router.push("/")}
        ...
        <div className="flex justify-center mb-8" suppressHydrationWarning>
          <div className="flex flex-col items-center gap-3" suppressHydrationWarning>
            ...
            <div className="flex items-center gap-2 bg-purple-500/20 px-4 py-2 rounded-full border border-purple-400/30">
              ...
              <span className="text-purple-300 font-semibold text-sm">Facilitator Portal</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20" suppressHydrationWarning>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" suppressHydrationWarning>
            ...
            <div suppressHydrationWarning>
              ...
              <div className="relative" suppressHydrationWarning>
                <input
                  ...
                  id="password"
                  {...register("password")}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-purple-400 pr-12"
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full px-4 py-3 bg-purple-500 text-white rounded-lg font-semibold hover:bg-purple-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              suppressHydrationWarning
            >
              {isPending ? (
                <>
