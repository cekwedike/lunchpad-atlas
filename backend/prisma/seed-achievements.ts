...
const ACHIEVEMENTS: Array<{
  ...
  { name: 'Point Starter',      description: 'Earn 50 points',                                                                          type: AchievementType.LEADERBOARD, iconUrl: 'TrendingUp',    pointValue: 15,   criteria: { totalPoints: 50 } },
  { name: 'Point Collector',    description: 'Earn 100 points',                                                                         type: AchievementType.LEADERBOARD, iconUrl: 'Gem',           pointValue: 25,   criteria: { totalPoints: 100 } },
  { name: 'Point Accumulator',  description: 'Earn 250 points',                                                                         type: AchievementType.LEADERBOARD, iconUrl: 'BadgeCheck',    pointValue: 50,   criteria: { totalPoints: 250 } },
  { name: 'Point Hoarder',      description: 'Earn 500 points',                                                                         type: AchievementType.LEADERBOARD, iconUrl: 'Wallet',        pointValue: 75,   criteria: { totalPoints: 500 } },
  { name: 'Point Enthusiast',   description: 'Earn 1,000 points',                                                                       type: AchievementType.LEADERBOARD, iconUrl: 'Coins',         pointValue: 100,  criteria: { totalPoints: 1000 } },
  { name: 'Point Expert',       description: 'Earn 2,500 points',                                                                       type: AchievementType.LEADERBOARD, iconUrl: 'CircleDollarSign', pointValue: 150, criteria: { totalPoints: 2500 } },
  { name: 'Point Legend',       description: 'Earn 5,000 points',                                                                       type: AchievementType.LEADERBOARD, iconUrl: 'ShieldCheck',   pointValue: 200,  criteria: { totalPoints: 5000 } },
  { name: 'Point Elite',        description: 'Earn 10,000 points',                                                                      type: AchievementType.LEADERBOARD, iconUrl: 'Swords',        pointValue: 300,  criteria: { totalPoints: 10000 } },
  { name: 'Living Legend',      description: 'Earn 25,000 points',                                                                      type: AchievementType.LEADERBOARD, iconUrl: 'FlameKindling', pointValue: 500,  criteria: { totalPoints: 25000 } },
  { name: 'The GOAT',           description: 'Earn 50,000 points — the greatest of all time',                                           type: AchievementType.LEADERBOARD, iconUrl: 'Infinity',      pointValue: 1000, criteria: { totalPoints: 50000 } },
];
